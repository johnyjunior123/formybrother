...
export function Login() {
    return (
        <section className={`${CupCakes.className} flex flex-col justify-center items-center w-80 bg-[#F9F4EA] p-6 rounded-[20px] shadow-[6px_6px_0_#000000] border border-black relative text-center`}>
            ...
            <div className="mb-4 relative">
                ...
                <input
                    placeholder="PRIMEIRO BEIJO"
                    disabled
                    type="text"
                    className='placeholder-black w-full pl-10 py-2 rounded-md bg-white border-2 border-black shadow-[3px_3px_0_#FFD93D] font-bold tracking-widest text-center disabled' />
            </div>
            <div className="mb-4 relative">
                <div className="absolute left-0 top-0 flex items-center pl-2 h-full">
                ...
                <input className='font-cup-cakes w-full pl-10 py-2 rounded-md bg-white border-2 border-black shadow-[3px_3px_0_#FFD93D] font-bold tracking-widest text-center text-black caret-black' />
            </div>

            <button
                type='submit'
                className="cursor-pointer bg-gradient-to-b from-yellow-300 to-orange-400 border-2 border-black px-6 py-2 rounded-full text-white font-bold shadow-[3px_3px_0_#000000] hover:scale-105 transition-transform"
            >Login</button>
        </section>
    )
}